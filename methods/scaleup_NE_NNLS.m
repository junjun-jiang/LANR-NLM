function [imgs, midres] = scaleup_NE_NNLS(conf, imgs, K)

% Super-Resolution Iteration
    fprintf('Scale-Up NE+NNLS');
    ...
    for i = 1:numel(midres)
        ...
        for t = 1:size(features,2)
            ...
            % Use K atom neighbors and obtain the NNLS coefficients
            coeffs = lsqnonneg(conf.dict_lores(:,idx(1:K)),features(:,t));
